...
# 1:다 관계의 객체처리.
1. 생각해봅시다.
	1)	현실에서 1:다수 관계가 어떤것이 있을까?
		 ex)버스안에 승객, 편의점에서, 마트에서 물건 구매할 때,
		 	컴퓨터의 구성요소로 여러개의 부품들, 한 반에 여러명의 학생들,
		 	...
	2)	웹프로그래밍에서 처리해야할 1:다 관계 어떤 것이 있을까?
